...
function Header({ openFileExplorer, projectName, handleModal }) {
  return (
    <header className='flex justify-between p-3 bg-primary'>
      ...
      <div className='flex items-center'>
        ...
        <div className="tooltip tooltip-left" data-tip="Open a new project">
          <button className="btn" onClick={() => handleModal()}><img className='h-7' src={dirUpload} alt='open folder button'/></button>
        </div>
